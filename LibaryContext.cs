...
namespace Libary_asm
{
    public class LibaryContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(new User{UserId=1 , Username="thangln", Password="123"});

            modelBuilder.Entity<Category>().HasData(new Category{CategoryId= 1, Name="Test2"});

            modelBuilder.Entity<Book>().HasData(new Book {BookId = 1, Name="Flutter Chat App 1 ", Author="Alex James 1", CategoryId=1});
            modelBuilder.Entity<Book>().HasData(new Book {BookId = 2, Name="Flutter Chat App 2", Author="Alex James 2", CategoryId=1});
            modelBuilder.Entity<Book>().HasData(new Book {BookId = 3, Name="Flutter Chat App 3", Author="Alex James 3", CategoryId=1});
            modelBuilder.Entity<Book>().HasData(new Book {BookId = 4, Name="Flutter Chat App 4", Author="Alex James 4", CategoryId=1});
